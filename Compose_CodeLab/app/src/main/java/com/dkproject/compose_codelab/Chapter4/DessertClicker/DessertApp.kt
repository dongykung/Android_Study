...
fun DesertApp(
    ...
    var currentDessertPrice by rememberSaveable { mutableIntStateOf(desserts[currentDessertIndex].price) }
        ...
        Column {
            Box(
                ...
                Image(
                    ...
                    contentDescription = null,
                    modifier = Modifier
                        .width(dimensionResource(R.dimen.image_size150))
                        .height(dimensionResource(R.dimen.image_size150))
...
private fun DessertClickerAppPreview() {
